...
BInt.register_test('spdrn:gss_win_fires_at_ante_9', function(test)
	...
	local ok, err = pcall(function()
		MPAPI._handle_gamemode_result(instance, instance:calculate({ ante_change = true, ante = 9 }))
...
BInt.register_test('spdrn:gss_no_win_below_ante_9', function(test)
	...
	local ok, err = pcall(function()
		MPAPI._handle_gamemode_result(instance, instance:calculate({ ante_change = true, ante = 8 }))
...
BInt.register_test('spdrn:gss_ante_reset_clears_guard', function(test)
	...
	local ok, err = pcall(function()
		MPAPI._handle_gamemode_result(instance, instance:calculate({ ante_change = true, ante = 9 }))
		MPAPI._handle_gamemode_result(instance, instance:calculate({ ante_change = true, ante = 1 })) -- reset flag
		MPAPI._handle_gamemode_result(instance, instance:calculate({ ante_change = true, ante = 9 }))
...
BInt.register_test('spdrn:gss_no_lobby_no_broadcast', function(test)
	...
	local ok, err = pcall(function()
		MPAPI._handle_gamemode_result(instance, instance:calculate({ ante_change = true, ante = 9 })) -- no lobby, should be silent
...
BInt.register_test('spdrn:gss_forfeit_last_player_wins', function(test)
	...
	local ok, err = pcall(function()
		MPAPI._handle_gamemode_result(instance, instance:on_player_forfeit('p2'))
...
BInt.register_test('spdrn:gss_forfeit_already_sole_player', function(test)
	...
	local ok, err = pcall(function()
		MPAPI._handle_gamemode_result(instance, instance:on_player_forfeit('p1'))
...
BInt.register_test('spdrn:wst_ante_reset_clears_flag', function(test)
	...
	local ok, err = pcall(function()
		MPAPI._handle_gamemode_result(instance, instance:calculate({ ante_change = true, ante = 1 }))
